...
This project has no features documented yet. As features are built, add a `##` section per feature/area here (e.g. `## Authentication`, `## Data Layer`, `## Editor UI`) describing its design, constraints, and any non-obvious decisions.
