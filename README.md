...
1. **Keep docs in sync with code.** Whenever you make a code change, update README.md and/or ARCHITECTURE.md in the same task if the change affects a rule, workflow, or feature described there. Do not leave documentation stale — treat doc updates as part of the change, not a follow-up.
